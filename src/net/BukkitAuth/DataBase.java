...
import net.BukkitPE.command.SimpleCommandMap;
...
public class DataBase {
	...
	public void registerCommands() {
		registerCommand(get("command-login"), get("command-login-description"), get("command-login-usage"), "net.BukkitPELogin.commands.login");
		registerCommand(get("command-register"), get("command-register-description"), get("command-register-usage"), "net.BukkitPELogin.commands.register");
		registerCommand(get("command-manage"), get("command-manage-description"), get("command-manage-usage"), "net.BukkitPELogin.commands.manage");
	}
